...
const ScribeCard = ({ scribe, onSaveToggle, onPress, onCommentPress, onDelete }: ScribeCardProps) => {
    ...
    React.useEffect(() => {
        if (storeInteraction === undefined && displayScribe.id) {
    ...
    }, [displayScribe.id, storeInteraction, setInteraction]);
            ...
            <View style={[styles.actions, { backgroundColor: colors.background, borderColor: colors.border + '40' }]}>
                ...
                <TouchableOpacity style={styles.actionBtn} activeOpacity={0.7} onPress={onCommentPress || onPress}>
                    ...
                    <Text style={[styles.actionCount, { color: colors.textSecondary }]}>
                        {formatCount(interaction.comment_count ?? displayScribe.comment_count ?? 0)}
                    </Text>
                </TouchableOpacity>
